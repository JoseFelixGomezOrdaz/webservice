CREATE DATABASE ferreteria_jfgo;
...
('pedro', 'hernandez', 'luqueno', 7751092470, 'pedro908@gmail.com');
...
CREATE USER 'ferreteria'@'localhost' IDENTIFIED BY 'ferre.2019';
GRANT ALL PRIVILEGES ON ferreteria_jfgo.* TO 'ferreteria'@'localhost';
FLUSH PRIVILEGES;
